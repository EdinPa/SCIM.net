    ...
    public abstract class BasicHttpAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            if (actionContext == null)
                throw new ScimException(HttpStatusCode.NonAuthoritativeInformation, "no actionContext");
        ...
        private HttpResponseMessage CreateUnauthorizedResponse(HttpRequestMessage request)
        {
            ...
            result.Headers.Add(BASIC_AUTH_RESPONSE_HEADER, BASIC_AUTH_RESPONSE_HEADER_VALUE);
            return result;
        }
        ...
        private bool AuthorizeRequest(HttpRequestMessage request)
        {
            ...
            if (authValue == null || String.IsNullOrWhiteSpace(authValue.Parameter)
                ...
                || authValue.Scheme != BASIC_AUTH_RESPONSE_HEADER_VALUE)
            {
                return false;
            }
        ...
        {
            string[] credentials = Encoding.ASCII.GetString(Convert.FromBase64String(authHeader))
                .Split(
                    new[] {':'});
